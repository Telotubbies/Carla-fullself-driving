...
Handles connection to CARLA server with retry logic and timeout management.
Follows Single Responsibility Principle - only handles connection logic.
"""
...
class CarlaConnectionManager:
    """Manages connection to CARLA server with retry and error handling."""
