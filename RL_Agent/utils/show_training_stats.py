#!/usr/bin/env python3
"""
แสดงสถิติการฝึกอบรม: รถ อุปสรรค ความเร็ว
"""
...
def extract_training_stats(log_file: str):
    ...
    if step_lines:
        ...
        # ดึง reward จาก 10 steps ล่าสุด
        recent_rewards = []
    ...
    # 5. Info Metrics (speed, collision, distance, etc.)
