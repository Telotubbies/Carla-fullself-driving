...
EOF
    ...
    if [ "$EPOCHS_TRAINED" -ge 300 ]; then
        ...
        log "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        log "🚀 Starting ResNet Training..."
        log "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        stdbuf -oL -eL python3 training/finetune_resnet_lane.py \
            ...
            --batch-size 16 \
            --lr 0.001 \
            2>&1 | stdbuf -oL -eL tee -a "$TRAIN_LOG"
        log "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    fi
else
...
stdbuf -oL -eL python3 training/extract_features.py \
    --data-dir "$LATEST_DATA" \
...
stdbuf -oL -eL python3 training/train_lstm.py \
    --data-dir "$LATEST_DATA" \
    --epochs 150 \
    --batch-size 64 \
    --use-attention \
